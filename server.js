...
const CVs = require("./routes/cvs-routes");
const CoverLetter = require("./routes/cover-letter-routes");

const app = express();

const url =
  "mongodb+srv://shahzeb:shahzeb123@cluster0.eggx4.mongodb.net/cvapp?retryWrites=true&w=majority";
